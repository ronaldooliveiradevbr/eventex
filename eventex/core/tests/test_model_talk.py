...
class PeriodManagerTest(TestCase):
    ...
    def test_in_the_morning(self):
        qs = Talk.objects.in_the_morning()
        expected = ['Morning Talk']
        self.assertQuerysetEqual(qs, expected, lambda o: o.title)

    def test_in_the_afternoon(self):
        qs = Talk.objects.in_the_afternoon()
...
class CourseModelTest(TestCase):
    ...
    def test_speakers(self):
        self.course.speakers.create(
            name='Ronaldo Oliveira',
            slug='ronaldo-oliveira',
            website='http://ronaldooliveira.net'
        )
